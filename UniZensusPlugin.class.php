...
*/
    ...
    {
        return array('eval_public' => null,'eval_stored' => null,'eval_public_stud' => null);
        /*
    ...
    function show_action()
    {
        ...
        if ($GLOBALS['perm']->get_studip_perm($this->getId()) == 'dozent') {
            ...
            echo sprintf(_("Diese Teilnehmeranzahl wird zur Auswertung der Evaluation herangezogen. Wenn Sie einen neuen Wert eingeben, wird Ihnen dieser nach einer n�chtlichen Aktualisierung der Daten am n�chsten Tag in dem Ergebnis-PDF angezeigt. Wenn Sie keinen anderen Wert eingeben, wird die Anzahl der Teilnehmer aus Stud.IP benutzt (zur Zeit: %s).")
...
<<<<<<< HEAD
            ...
            echo '</td><td>';
            echo '<div style="font-style:italic; padding-left: 10px;">';
            echo sprintf(_("Mit der <b>�bermittlung</b> der Auswertung der Ergebnisse <u>inklusive</u> der Freitextantworten <b>an die Studierenden</b> dieser Lehrveranstaltung bin ich einverstanden. Mir ist bekannt, dass ich meine Einwilligung jederzeit ohne Angabe von Gr�nden mit Wirkung f�r die Zukunft widerrufen kann.")
            , htmlready(Seminar::getInstance($this->getId())->getName()) );
            echo '</div>';
            echo '</td></tr>';
            echo '<tr><td>';
            ...
            echo '</td><td>';
            echo '<div style="font-style:italic; padding-left: 10px;">';
            echo sprintf(_("Mit der <b>�bermittlung</b> der Auswertung der Ergebnisse <u>ohne</u> die Freitextantworten <b>an die Studierenden</b> dieser Lehrveranstaltung bin ich einverstanden. Mir ist bekannt, dass ich meine Einwilligung jederzeit ohne Angabe von Gr�nden mit Wirkung f�r die Zukunft widerrufen kann.")
=======
...
>>>>>>> master
            ...
            echo '<div style="font-style:italic; padding-left: 10px;">';
<<<<<<< HEAD
            echo sprintf(_("Mit der <b>�bermittlung</b> der Auswertung der Ergebnisse der studentischen Lehrveranstaltungsevaluation aus der Lehrveranstaltung (%s) <b>an die Studiendekanin bzw. den Studiendekan und die Evaluationsbeauftragte bzw. den Evaluationsbeauftragten</b> bin ich einverstanden. Mir ist bekannt, dass ich meine Einwilligung jederzeit ohne Angabe von Gr�nden mit Wirkung f�r die Zukunft widerrufen kann.")
=======
