            ...
            if ($this->course_status['preview'] || $this->course_status['pdfquestionnaire'] || $this->course_status['questionnaire'] || $this->course_status['noresultsreason'] || $results_available){
                ...
                if ($results_available
                    ...
                    if ($additional_data['eval_public_stud']) {
                        ...
                        if ($additional_data['eval_public_stud'] == 2 && $this->checkResultforUser('pdfdetail', $checked_user_id)) {
                            echo chr(10) . '<p><a target="_blank" href="' . $this->RPC->getEvaluationURL('pdfdetail', $this->getZensusCourseId(), $checked_user_id) . '">';
                            echo chr(10) . '<img src="' . $pluginrelativepath . '/images/pdf-icon.gif" hspace="2" border="0" align="absbottom">' . _("Die Ergebnisse (Detailauswertung ohne Kommentare) der Evaluation als PDF aufrufen") . '</a></p>';
                        }
